...
namespace Project_Nhom1.Classes
{
    class Funtions
    {
        ...
        {
            connString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=E:\Lab\GitHub\CSharp-Programming\SQL\Quan_ly_cua_hang_sua_giay_dep\Project_Nhom1\Database\Database_CuaHang.mdf;Integrated Security=True;Connect Timeout=30";
