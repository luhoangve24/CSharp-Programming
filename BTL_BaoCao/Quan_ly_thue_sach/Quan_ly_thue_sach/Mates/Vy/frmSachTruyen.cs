...
namespace Quan_ly_thue_sach.Forms
{
    public partial class frmSachTruyen : Form
    {
        ...
        {
            string sql;
            sql = "select a.Masach, a.Tensach, b.Tenloai, a.Malinhvuc, a.Matacgia, a.MaNXB, a.Mangonngu, a.Sotrang, a.Giasach, a.Dongiathue, a.Soluong, a.Anh, a.Ghichu from tblSach a, tblLoaisach b";
        ...
        {
            string mals, malv, matg, manxb, mann;
            ...
            // cboMaloaisach.Text=Classes.Funtions.GetFieldValues("select Maloai from tblLoaisach where Maloai=N'" + mals + "'");
            cboMaloaisach.Text = dgrid_sachtruyen.CurrentRow.Cells["Maloai"].Value.ToString();
