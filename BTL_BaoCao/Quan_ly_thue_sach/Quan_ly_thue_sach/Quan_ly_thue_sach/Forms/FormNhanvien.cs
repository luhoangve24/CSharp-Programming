...
namespace Quan_ly_thue_sach.Forms
{
    public partial class frmNhanvien : Form
    {
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE tblNV SET TenNV = N'"+txtTen.Text+"', Maca = N'"+ma+"', Namsinh = '"+Funtions.ConvertDateTime(mskNamsinh.Text)+"', Gioitinh = N'"+gt+ "', Diachi = N'"+txtDiachi.Text+"', Dienthoai = '"+mskSDT.Text+"', Luong = "+txtLuong.Text+" WHERE MaNV = N'"+txtMaNV.Text+"'";
            Funtions.RunSQL(sql);
            Load_DG();
            Reset_Values();
            btnBoqua.Enabled = false;
