...
namespace Quan_ly_thue_sach.Forms
{
    public partial class frmHDThuesach : Form
    {
        ...
        private void Load_DVChitiet() // Từng cuốn sách
        {
            string sql;
            ...
            string[] Header = new string[11] { "Mã khách", "Mã sách", "Mã thuê", "Tên khách", "Địa chỉ", "Ngày thuê", "Tên sách", "Đơn giá thuê", "Mã tình trạng", "Đã trả", "Giá sách" };
        ...
        private void Load_ThongtinHD() // Thông tin hóa đơn chung
        {
            string sql;
        ...
        {
            Funtions.FillCombo("SELECT Masach FROM tblSach WHERE Soluong > 0", cboMasach, "Masach", "Masach");
            cboMasach.SelectedIndex = -1;
        }
    }
}
