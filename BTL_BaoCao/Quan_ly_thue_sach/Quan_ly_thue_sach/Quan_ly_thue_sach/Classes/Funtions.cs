...
namespace Quan_ly_thue_sach.Classes
{
    class Funtions
    {
        ...
        {
            connString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\Downloads\Compressed\Quan_ly_thue_sach\Quan_ly_thue_sach\Quan_ly_thue_sach\Quan_ly_thue_sach\Database\QL_ThueSach.mdf;Integrated Security=True;Connect Timeout=30";
        ...
        public static bool Login(string userName, string userPassword)
        {
            ...
            //query = "SELECT * FROM tblAccount WHERE UserName = N'" + userName + "' AND PassWord = N'" + userPassword + "'"; -- SQL Injection
            try
            {
            ...
            {
                MessageBox.Show("Định dùng SQL Injection ? Mơ đi bạn ", "Xin chào", MessageBoxButtons.OK, MessageBoxIcon.Question);
            }
